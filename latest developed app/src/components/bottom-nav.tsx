import { Dumbbell, UtensilsCrossed, TrendingUp, FileText } from 'lucide-react';
import { t, Language } from '../lib/i18n';

interface BottomNavProps {
  activeTab: 'workouts' | 'meals' | 'progress' | 'report';
  onTabChange: (tab: 'workouts' | 'meals' | 'progress' | 'report') => void;
  language: Language;
}
